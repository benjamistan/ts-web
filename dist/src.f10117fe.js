...
function () {
  ...
  }; // Maps over fragment and loads all regions into the regions array
...
/** @class */
function () {
  function Collection(rootUrl, deserialize // Takes in 'props' object and returns a T object
  ) {
...
var axios_1 = __importDefault(require("axios")); // extending HasId to force <T> to have ID constraint
